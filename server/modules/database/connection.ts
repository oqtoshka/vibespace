...
function resolveDatabasePath(): string {
    // process.env.DATABASE_PATH is set by load-env-vars.js to either the .env value or a default(~/.vibespace/auth.db) in the user's home directory. 
...
/**
 * If the database was moved to an external location (e.g. ~/.vibespace/)
