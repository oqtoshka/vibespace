...
async function startServer() {
    ...
    // Import and run the server. (The session restore-on-boot pass arms itself
    // from claude-sdk.js's module scope, which this import pulls in — it opens
    // resumed turns as real chat-runs, which this wrapper couldn't.)
