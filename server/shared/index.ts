...
// OIDC, manager registry and worker auth share the exact managed identity rules.
export { isManagedUsername } from './utils.js';
...
export { appendFilesInputTag, isImageAttachmentDescriptor } from './image-attachments.js';
